...
Alternatively you have access to a NewsletterMailer ActionMailer object with a publish method
  NewsletterMailer.publish('my_newsletter_partial', :name => 'User name', :email => 'user@example.com').deliver
